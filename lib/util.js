...
export const toSetString = supportsNullProto ? identity : toSetString_f;

function fromSetString_f(aStr) {
  if (isProtoString(aStr)) {
    return aStr.slice(1);
  }
...
export const fromSetString = supportsNullProto ? identity : fromSetString_f;
